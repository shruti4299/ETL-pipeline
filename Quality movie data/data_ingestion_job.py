...
AmazonS3_node1715850863589 = glueContext.create_dynamic_frame.from_catalog(database="movies-db", table_name="imdb_movies_rating", transformation_ctx="AmazonS3_node1715850863589")

# Script generated for node Evaluate Data Quality
EvaluateDataQuality_node1715850895378_ruleset = """
...
EvaluateDataQuality_node1715850895378 = EvaluateDataQuality().process_rows(frame=AmazonS3_node1715850863589, ruleset=EvaluateDataQuality_node1715850895378_ruleset, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1715850895378", "enableDataQualityCloudWatchMetrics": True, "enableDataQualityResultsPublishing": True}, additional_options={"performanceTuning.caching":"CACHE_NOTHING"})

# Script generated for node ruleOutcomes
ruleOutcomes_node1715850917463 = SelectFromCollection.apply(dfc=EvaluateDataQuality_node1715850895378, key="ruleOutcomes", transformation_ctx="ruleOutcomes_node1715850917463")

# Script generated for node rowLevelOutcomes
rowLevelOutcomes_node1715850920551 = SelectFromCollection.apply(dfc=EvaluateDataQuality_node1715850895378, key="rowLevelOutcomes", transformation_ctx="rowLevelOutcomes_node1715850920551")

# Script generated for node Conditional Router
ConditionalRouter_node1715851098192 = threadedRoute(glueContext,
  source_DyF = rowLevelOutcomes_node1715850920551,
...
output_group_1_node1715851098573 = SelectFromCollection.apply(dfc=ConditionalRouter_node1715851098192, key="output_group_1", transformation_ctx="output_group_1_node1715851098573")

# Script generated for node default_group
default_group_node1715851098494 = SelectFromCollection.apply(dfc=ConditionalRouter_node1715851098192, key="default_group", transformation_ctx="default_group_node1715851098494")

# Script generated for node Change Schema
ChangeSchema_node1715851332161 = ApplyMapping.apply(frame=default_group_node1715851098494, mappings=[("poster_link", "string", "poster_link", "string"), ("series_title", "string", "series_title", "string"), ("released_year", "string", "released_year", "string"), ("certificate", "string", "certificate", "string"), ("runtime", "string", "runtime", "string"), ("genre", "string", "genre", "string"), ("imdb_rating", "double", "imdb_rating", "double"), ("overview", "string", "overview", "string"), ("meta_score", "long", "meta_score", "long"), ("director", "string", "director", "string"), ("star1", "string", "star1", "string"), ("star2", "string", "star2", "string"), ("star3", "string", "star3", "string"), ("star4", "string", "star4", "string"), ("no_of_votes", "long", "no_of_votes", "long"), ("gross", "string", "gross", "string")], transformation_ctx="ChangeSchema_node1715851332161")

# Script generated for node Amazon S3
AmazonS3_node1715850975106 = glueContext.write_dynamic_frame.from_options(frame=ruleOutcomes_node1715850917463, connection_type="s3", format="json", connection_options={"path": "s3://movie-data-quality-results/rules_outcome/", "compression": "snappy", "partitionKeys": []}, transformation_ctx="AmazonS3_node1715850975106")

# Script generated for node Amazon S3
AmazonS3_node1715851173352 = glueContext.write_dynamic_frame.from_options(frame=output_group_1_node1715851098573, connection_type="s3", format="json", connection_options={"path": "s3://movie-data-quality-results/failed_records/", "compression": "snappy", "partitionKeys": []}, transformation_ctx="AmazonS3_node1715851173352")

# Script generated for node Amazon Redshift
AmazonRedshift_node1715851484097 = glueContext.write_dynamic_frame.from_options(frame=ChangeSchema_node1715851332161, connection_type="redshift", connection_options={"redshiftTmpDir": "s3://aws-glue-assets-670567716617-ap-southeast-2/temporary/", "useConnectionProperties": "true", "dbtable": "movies.imdb_movies_rating", "connectionName": "Movies redshift connection", "preactions": "CREATE TABLE IF NOT EXISTS movies.imdb_movies_rating (poster_link VARCHAR, series_title VARCHAR, released_year VARCHAR, certificate VARCHAR, runtime VARCHAR, genre VARCHAR, imdb_rating DOUBLE PRECISION, overview VARCHAR, meta_score BIGINT, director VARCHAR, star1 VARCHAR, star2 VARCHAR, star3 VARCHAR, star4 VARCHAR, no_of_votes BIGINT, gross VARCHAR);"}, transformation_ctx="AmazonRedshift_node1715851484097")
